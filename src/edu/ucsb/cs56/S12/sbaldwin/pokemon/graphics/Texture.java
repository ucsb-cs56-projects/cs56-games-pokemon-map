...
public class Texture
{
    ...
    public BufferedImage getTileSheet() { return this.tileSheet;}

	public Rectangle srcRect() {return bounds;}

    public int width()  { return bounds.width;}

    public int height() {return bounds.height;}

    public int srcX1() {return bounds.x;}
    public int srcX2() {return bounds.x + bounds.width;}
    public int srcY1() {return bounds.y;}
    public int srcY2() {return bounds.y + bounds.height;}
}
